...
let modified_substring = document.getElementById("legacy_text").value  ;

//****************************************************************************************
//  Break the long text into small bunches of max. max_text_size  characters each.
//****************************************************************************************
    let text_size = document.getElementById("legacy_text").value.length ;

    let processed_text = '' ;  //blank

    let sthiti1 = 0 ;  let sthiti2 = 0 ;  let chale_chalo = 1 ;
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     let modified_substring = document.getElementById("legacy_text").value.substring ( sthiti1, sthiti2 )  ;
...
{
let charecter_next_to_i = modified_substring.charAt( position_of_i + 1 )
let charecter_to_be_replaced = "f" + charecter_next_to_i
...
let position_of_i = modified_substring.indexOf( "fa" )

while ( position_of_i != -1 )  //while-02
{
let charecter_next_to_ip2 = modified_substring.charAt( position_of_i + 2 )
let charecter_to_be_replaced = "fa" + charecter_next_to_ip2
...
/*
let position_of_i = modified_substring.indexOf( "h" )

while ( position_of_i != -1 )  //while-02
{
let charecter_next_to_i = modified_substring.charAt( position_of_i + 1 )
let charecter_to_be_replaced = "h" + charecter_next_to_i
...
{
let consonent_next_to_wrong_ee = modified_substring.charAt( position_of_wrong_ee + 2 )
let charecter_to_be_replaced = "ि्" + consonent_next_to_wrong_ee 
...
let charecter_at_probable_position_of_half_r = modified_substring.charAt( probable_position_of_half_r )
...
let modified_substring = document.getElementById("unicode_text").value  ;

//****************************************************************************************
//  Break the long text into small bunches of max. max_text_size  characters each.
//****************************************************************************************
    let text_size = document.getElementById("unicode_text").value.length ;
   ...
   //************************************************************
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     let modified_substring = document.getElementById("unicode_text").value.substring ( sthiti1, sthiti2 )  ;
         ...
         while ( position_of_f != -1 )  //while-02
           {
            ...
            while (( modified_substring.charAt( position_of_f - 1 ) == "्" )  &  ( position_of_f != 0  ) )
               {
                let string_to_be_replaced = modified_substring.charAt( position_of_f - 2 ) + "्"  ;
